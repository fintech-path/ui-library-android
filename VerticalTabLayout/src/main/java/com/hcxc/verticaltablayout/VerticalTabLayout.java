...
public class VerticalTabLayout extends ScrollView implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mIndicatorColor = typedArray.getColor(R.styleable.VerticalTabLayout_vTabIndicatorColor, mIndicatorColor);
        mArrowColor = typedArray.getColor(R.styleable.VerticalTabLayout_vTabArrowColor, mArrowColor);
        mArrowGravity = typedArray.getInteger(R.styleable.VerticalTabLayout_vTabArrowGravity, mArrowGravity);
        mIndicatorWidth = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vTabIndicatorWidth, dpToPx(5));
        mIndicatorCorners = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vTabIndicatorCorners, mDividerHeight);
        mDividerHeight = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vDividerHeight, mDividerHeight);
        mDividerColor = typedArray.getColor(R.styleable.VerticalTabLayout_vDividerColor, Color.TRANSPARENT);
        mDividerPadding = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vDividerPadding, mDividerPadding);
        mIndicatorGravity = typedArray.getInteger(R.styleable.VerticalTabLayout_vTabIndicatorGravity, mIndicatorGravity);
        mTabHeight = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vTabHeight, LayoutParams.MATCH_PARENT);
        mTabTextColor = typedArray.getColor(R.styleable.VerticalTabLayout_vTabTextColor, mTabTextColor);
        mTabSelectedTextColor = typedArray.getColor(R.styleable.VerticalTabLayout_vTabSelectedTextColor, mTabSelectedTextColor);
        mTabTextAppearance = typedArray.getResourceId(R.styleable.VerticalTabLayout_vTabTextAppearance, mTabTextAppearance);
        mTabTextSize = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vTabTextSize, mTabTextSize);
        mTabPadding = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vTabPadding, mTabPadding);
        mTabPaddingLeft = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vTabPaddingLeft, mTabPaddingLeft);
        mTabPaddingRight = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vTabPaddingRight, mTabPaddingRight);
        mTabPaddingTop = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vTabPaddingTop, mTabPaddingTop);
        mTabPaddingBottom = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vTabPaddingBottom, mTabPaddingBottom);
        mTabGravity = typedArray.getInteger(R.styleable.VerticalTabLayout_vTabViewGravity, mTabGravity);
        mArrowType = typedArray.getInteger(R.styleable.VerticalTabLayout_vTabArrowType, mArrowType);
        mTabDrawablePadding = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_vTabIconPadding, mTabDrawablePadding);
        typedArray.recycle();
        initLayout();
    }
